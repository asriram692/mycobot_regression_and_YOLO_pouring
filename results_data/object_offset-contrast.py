...
hardcoded_table_offsets = {
    ...
    "Pos 2 (Top-R)": (15.5, 17),
    "Pos 3 (Mid-L)": (24.1, -12.1),
    "Pos 4 (Mid-R)": (5.8, -1.5),
    "Pos 5 (Bot-L)": (-20.3, 5.4),
    "Pos 6 (Bot-R)": (-13.8, 2.4),
}

nn_table_offsets = {
    "Pos 1 (Top-L)": [(28.6, 9.1), (14.31, 3.8), (26.8, 3.8)],
    "Pos 2 (Top-R)": [(4.1, 27.7), (19, 14.6), (26.2, 6.5)],
    "Pos 3 (Mid-L)": [(41.4, 8.2), (26.5, 34.4), (50.6, 12)],
    "Pos 4 (Mid-R)": [(30.216, 36), (38.2, 35.3), (29, 33.1)],
    "Pos 5 (Bot-L)": [(52.2, 10), (7.7, 2.1), (25.8, 3.1)],
    "Pos 6 (Bot-R)": [(3.12, 22.8), (0, 7), (8, 6)],
}
