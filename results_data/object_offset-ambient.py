...
vs. Direct Coordinate Regression under ambient lighting conditions.
"""
...
ambient_nn = {
    "Pos 1 (Top-L)": [(34.1, 7.9), (33.7, 4.5), (15.2, 13)],
    "Pos 2 (Top-R)": [(10.5, 12.1), (8.1, 7.5), (1.1, 5.9)],
    "Pos 3 (Mid-L)": [(5.8, 1.5), (7.4, 3.0), (8.9, 1.1)],
    "Pos 4 (Mid-R)": [(6.2, 18.3), (2.2, 1), (2, 0)],
    "Pos 5 (Bot-L)": [(35, 19.4), (27.2, 26.5), (14.4, 4.2)],
    "Pos 6 (Bot-R)": [(-38.79, 21.1), (3.6, 15.6), (9.8, 2)],
}
...
for idx, (spot_label, (gt_x, gt_y)) in enumerate(gt_coords.items()):
  ...
  if spot_label in ambient_hc:
    hc_dx, hc_dy = ambient_hc[spot_label]
  ...
  if spot_label in ambient_nn:
    offsets = np.array(ambient_nn[spot_label])
...
ax.set_title(
    "Ambient Lighting (Control) Pour Offsets", fontsize=14, fontweight="bold"
)
...
# Add extra bottom margin and push legend down cleanly
...
plt.savefig("ambient_offsets.png", dpi=300, bbox_inches="tight")
plt.show()