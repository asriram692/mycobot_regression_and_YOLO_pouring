...
gt_coords_ambient = {
    ...
    "Pos 3 (Mid-L)": (123.1, 33.8),
    "Pos 4 (Mid-R)": (162.1, 32.5),
    "Pos 5 (Bot-L)": (128.0, -65.4),
    "Pos 6 (Bot-R)": (191.7, -97.3)
}

nn_preds_ambient = {
    "Pos 1 (Top-L)": [(106.0, 139.7), (112.2, 132.3), (110.3, 137.4)],
    "Pos 2 (Top-R)": [(118.7, 141.7), (121.0, 151.5), (122.8, 148.4)],
    "Pos 3 (Mid-L)": [(119.6, 32.8), (126.1, 57.7), (125.7, 42.6)],
    "Pos 4 (Mid-R)": [(160.6, 39.0), (167.0, 57.5), (177.0, 46.5)],
    "Pos 5 (Bot-L)": [(118.6, -47.1), (115.9, -60.1), (109.5, -48.1), (112.9, -50.1), (114.8, -48.0)],
    "Pos 6 (Bot-R)": [(183.6, -80.5), (183.4, -76.3), (190.6, -67.9)]
}
...
nn_preds_lowlight = {
    ...
    "Pos 3 (Mid-L)": [(119.5, 43.7), (119.2, 49.2), (120.4, 43.8)],
    "Pos 4 (Mid-R)": [(159.1, 40.5), (164.1, 32.6), (164.8, 33.2)],
    "Pos 5 (Bot-L)": [(109.5, -48.1), (112.9, -50.1), (114.8, -48.0)],
    "Pos 6 (Bot-R)": [(196.7, -87.0), (189.5, -67.0), (177.8, -88.4)]
}
...
nn_preds_contrast = {
    ...
    "Pos 3 (Mid-L)": [(130.8, 54.1), (135.0, 56.7), (133.8, 54.6)],
    "Pos 4 (Mid-R)": [(176.4, 30.8), (176.1, 41.4), (174.6, 46.5)],
    "Pos 5 (Bot-L)": [(131.6, -42.4), (133.5, -42.5), (138.5, -40.1)],
    "Pos 6 (Bot-R)": [(188.5, -89.9), (188.8, -81.7), (188.1, -75.8)]
}
    ...
    for spot_idx, (spot_label, (gt_x, gt_y)) in enumerate(gt_coords.items()):
        ...
        if spot_label in nn_predictions:
            ...
            ax.scatter(mean_x, mean_y, color=mean_color, marker='D', s=100, zorder=6, 
                       ...
                       label='Mean Regression Model Prediction' if (ax_idx == 0 and spot_idx == 0) else "")
